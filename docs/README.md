...
2. [`paper-summary.md`](paper-summary.md): resumen crítico del artículo de referencia y de sus
   diferencias con este proyecto.
3. [`fbrs.md`](fbrs.md): fundamentos de FBRS, adaptación a AnuraSet, decisiones configuradas y
   verificaciones requeridas.
4. [`experiments.md`](experiments.md): requisitos, estado y resultados de los experimentos.
