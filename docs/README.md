...
2. [`data-preparation.md`](data-preparation.md): política de selección de etiquetas, particiones
   y verificaciones de los manifiestos.
3. [`paper-summary.md`](paper-summary.md): resumen crítico del artículo de referencia y de sus
   diferencias con este proyecto.
4. [`fbrs.md`](fbrs.md): fundamentos de FBRS, adaptación a AnuraSet, decisiones configuradas y
   verificaciones requeridas.
5. [`experiments.md`](experiments.md): requisitos, estado y resultados de los experimentos.
